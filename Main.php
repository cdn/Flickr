...
namespace IdnoPlugins\Flickr {
    ...
    class Main extends \Idno\Common\Plugin
    {
        ...
        {
            // Deauth URL
                \Idno\Core\Idno::site()->addPageHandler(
        ...
        function registerEventHooks()
        {
            ...
            \Idno\Core\Idno::site()->syndication()->registerService(
                'flickr', function () {
                                    ...
                                    try {
                                        ...
                                        if ($bytes = \Idno\Entities\File::getFileDataFromAttachment(
                                            ...
                                            if ($ok == 'ok') {
                                                ...
                                                \Idno\Core\Idno::site()->logging()->log(
        ...
        function getAuthURL()
        {
            ...
            $login_url = \Idno\Core\Idno::site()->config()->getURL() .
            'flickr/callback';
            return $login_url;
                    ...
                    if (empty($username)) {
                        if (!empty(\Idno\Core\Idno::site()->session()->currentUser()->flickr['access_token'])) {
                            ...
                            $flickr->isValidOauthToken(
                                \Idno\Core\Idno::site()->session()->currentUser()->flickr['access_token'],
                        ...
                        if (!empty(\Idno\Core\Idno::site()->session()->currentUser()->flickr[$username])
                            ...
                            $flickr->isValidOauthToken(
                                \Idno\Core\Idno::site()->session()->currentUser()->flickr[$username]['access_token'],
