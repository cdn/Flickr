        ...
        if (empty(\Idno\Core\Idno::site()->session()->currentUser()->flickr)) {
                        ...
                        <div class="controls-config">
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <p>
                                        With Flickr connected, you can cross-post 
                                        images that you publish publicly on
                                        your site.
                                    </p>

                            <div class="social">
                                <p>
                                    <a href="<?php echo $vars['login_url']
                                    ?>" class="connect fl"><i class="fa 
                                    fa-flickr"></i> Connect Flickr</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <div class="controls-config">
                            <div class="row">
                                <div class="col-md-7">
                                    <p>
                                        Your account is currently connected to
                                        Flickr. Public content that you post
                                        here can be shared with your Flickr
                                        account.
                                    </p>
                                    ...
                                    <div class="social">
                                        ...
                                        ?>flickr/deauth" class="form-horizontal"
                                        method="post">
                                        <p>
            ...
            ?>
                                    ...
                                    <div class="social">
                                        <form action="<?php echo \Idno\Core\Idno::site()->config()->getDisplayURL()?>flickr/deauth" class="form-horizontal" method="post">
                                            <p>
                                                ...
                                                <button type="submit"
                                                        class="connect fl connected"><i class="fa fa-flickr"></i> <?php echo $account['username'] ?> (Disconnect)</button>
                                <?php echo \Idno\Core\Idno::site()->actions()->signForm('/flickr/deauth/') ?>
                                            </p>
                                        </form>
                                        </div>
                    ...
                    ?>
                          ...
                          <p>
                                        <a href="<?php echo $vars['login_url'] ?>" class=""><i class="fa fa-plus"></i> Add another Flickr account</a>
                                    </p>
                        </div>
                    </div>
                        </div>
